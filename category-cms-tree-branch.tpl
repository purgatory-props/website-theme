<li>
  <a href="{$node.link|escape:'html':'UTF-8'}" title="{$node.name|escape:'html':'UTF-8'}" class="textlink-nostyle">
    ...
    <ul>
      ...
      {if !empty($node.cms)}
        {foreach from=$node.cms item=cms }
          <li>
            <a href="{$cms.link|escape:'html':'UTF-8'}" title="{$cms.meta_title|escape:'html':'UTF-8'}" class="textlink-nostyle">
