<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std">
  ...
  <div class="account_creation">
    <h3 class="page-subheading">{l s='Your Information'}</h3>

    <div id="createFormErrors" style="display: none">
    </div>
  ...
  {if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
    <div class="account_creation">
      ...
      {foreach from=$dlv_all_fields item=field_name}
        ...
        {elseif $field_name eq "vat_number"}
          ...
          <div id="vat_number" style="display:none;">
            <div class="form-group">
              <label for="vat_number">{l s='VAT number'}{if in_array($field_name, $required_fields)} <sup class="required">*</sup>{/if}</label>
      ...
      <div class="required form-group" id="address_alias">
        <label for="alias">{l s='Assign an address alias for future reference.'} <sup class="required">*</sup></label>
