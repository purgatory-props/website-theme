...
<html lang="{$language_code|escape:'html':'UTF-8'}">
    ...
    <body>
        <div id="maintenance" class="text-center">
            <img class="center center-block img-responsive" src="{$logo_url}" alt="" {if $logo_image_width}width="{$logo_image_width}"{/if} {if $logo_image_height}height="{$logo_image_height}"{/if}>
