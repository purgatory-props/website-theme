    ...
    {if isset($order)}
        ...
        <div id="order-info-summary" class="box clearfix bg-color-dark">
            ...
            <div class="order-payment">
                {l s='Payment Method'}: <span class="payment-method">{$order->payment|escape:'html':'UTF-8'}</span>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6"{if $order->isVirtual()} style="display:none;"{/if}>
                    <ul class="address box">
                        <li>
                            <h3 class="page-subheading">{l s='Delivery address'} ({$address_delivery->alias})</h3>
                        </li>
        ...
        <div id="order-detail-content" class="table_block table-responsive">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        {if $return_allowed}<th class="order_cb"><div class="checkbox"><label><input type="checkbox"><span class="label-text"></span></label</div></th>{/if}
                        <th>{l s='Reference'}</th>
                        <th>{l s='Product'}</th>
                        <th>{l s='Quantity'}</th>
